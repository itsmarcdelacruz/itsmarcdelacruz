...
## 🚀 About Me
- Full stack developer focused on building clean, practical products with strong fundamentals.
- Interested in **security-minded engineering** and **AI/ML systems** (the kind that actually ship).
- I like fast feedback loops: ship → measure → refine.

---

## 🧩 What I'm Working On
- **Marketplace project** (full-stack build)
- **AI/ML project for Tarkov** (data + automation + experimentation)
...
### Backend
![Node.js](https://img.shields.io/badge/Node.js-111111?style=for-the-badge&logo=nodedotjs&logoColor=3C873A)
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-111111?style=for-the-badge&logo=githubactions&logoColor=white)
...
### Creative
![Music](https://img.shields.io/badge/Music_Production-111111?style=for-the-badge&logo=abletonlive&logoColor=white)
![Video Editing](https://img.shields.io/badge/Video_Editing-111111?style=for-the-badge&logo=adobe&logoColor=white)
![CapCut](https://img.shields.io/badge/CapCut-111111?style=for-the-badge&logo=capcut&logoColor=white)

---

## 🌟 Featured Repos
- 🔐 **CompTIA Security+ (SY0-701) Notes & Resources**  
  👉 https://github.com/itsmarcdelacruz/Comptia-Security-SY0-701

- 🖥️ **My Terminal Setup / CLI Workflow**  
  👉 https://github.com/itsmarcdelacruz/my-terminal

---

## 🧠 How I Work
- **Clarity first:** define the goal, constraints, and acceptance criteria.
- **Small iterations:** ship the smallest useful version, then refine.
- **Security mindset:** least privilege, safe defaults, validate inputs, log the right things.
- **Maintainable code:** predictable structure, readable naming, and tests where they matter.
- **Performance-aware:** avoid over-engineering, but measure bottlenecks when it counts.
...
### 🤝 Connect
<a href="https://itsmarcdelacruz.github.io/"><img src="https://img.shields.io/badge/Portfolio-111111?style=for-the-badge&logo=vercel&logoColor=white" /></a>
<a href="https://www.linkedin.com/in/itsmarcdelacruz/"><img src="https://img.shields.io/badge/LinkedIn-111111?style=for-the-badge&logo=linkedin&logoColor=0A66C2" /></a>
